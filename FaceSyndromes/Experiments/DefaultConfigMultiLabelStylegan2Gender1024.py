...
nvidia_pretrain=/data/duongdb/stylegan3-FaceSyndromes/NvidiaPretrainedModel/stylegan2-ffhq-1024x1024.pkl 
...
--cfg=stylegan2 --gpus=4 --batch=48 --gamma=5 --mirror=1 --kimg=15000 --snap=20  \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
...
os.system('sbatch --partition=gpu --time=2-00:00:00 --gres=gpu:v100x:4 --mem=32g --cpus-per-task=12 '+fname)
