...
--cond=True \
--label_embed_dim=512 \
--label_combo_dict='{"label1":[0,4],"label2":[4,9],"label3":[9,11]}' \
...
IMG_FOLDER = 'Res256WS22qOther2500NormalGenderNpr0Up5' # 'TfStyleGAN3LabelRes256'
...
os.system('sbatch --partition=gpu --time=3-00:00:00 --gres=gpu:p100:4 --mem=32g --cpus-per-task=12 '+fname)
