...
nvidia_pretrain=/data/duongdb/stylegan3-FaceSyndromes/NvidiaPretrainedModel/stylegan3-t-ffhq-1024x1024.pkl
...
--cfg=stylegan3-t --gpus=4 --batch=16 --gamma=6.6 --mirror=1 --kimg=10000 --snap=10 \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
...
IMG_FOLDER = 'Res1024WS22qOther10kNormalGenderNpr0Up10' # 'TfStyleGAN3LabelRes256'
...
os.system('sbatch --partition=gpu --time=4-00:00:00 --gres=gpu:v100x:4 --mem=32g --cpus-per-task=12 '+fname)
