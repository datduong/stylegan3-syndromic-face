...
--cfg=stylegan3-t --gpus=4 --batch=32 --gamma=6.6 --mirror=1 --kimg=10000 --snap=10 \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
...
IMG_FOLDER = 'TfStyleGAN3LabelRes1024Up10+Gender'
...
os.system('sbatch --partition=gpu --time=72:00:00 --gres=gpu:p100:4 --mem=32g --cpus-per-task=12 '+fname)
