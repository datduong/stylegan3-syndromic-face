...
datapath=/data/duongdb/ManyFaceConditions05092022
...
--cfg=stylegan2 --gpus=2 --batch=64 --gamma=0.2048 --glr=0.0025 --dlr=0.0025 --cbase=16384 \
--kimg=10000 --snap=10 \
--mirror=1 \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
--metrics=fid100_full #fid20k_full
...
os.chdir('/data/duongdb/ManyFaceConditions05092022')
counter = 1

IMG_FOLDER = 'Res256AlignPix255-0Normal-SkipAgeUp1-5' # 'Res256ManyCondition+10kNormal-OtherUp2-10' # 'TfStyleGAN3LabelRes256' Res256ManyCondition+10kNormal-OtherUp2-10
