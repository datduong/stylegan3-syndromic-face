...
nvidia_pretrain=/data/duongdb/stylegan3-FaceSyndromes/NvidiaPretrainedModel/stylegan2-ffhq-512x512.pkl 
...
--cfg=stylegan2 --gpus=4 --batch=48 --gamma=5 --mirror=1 --kimg=20000 --snap=20  \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
...
IMG_FOLDER = 'Res512ManyCondition+10kNormal-OtherUp4-20' # 'TfStyleGAN3LabelRes256'
