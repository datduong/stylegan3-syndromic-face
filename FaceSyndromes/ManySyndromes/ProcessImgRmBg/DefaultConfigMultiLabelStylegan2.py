...
# ! load stylegan3-t-ffhq-256x256.pkl too ?
...
# ! metface at 1024 --cfg=stylegan3-t --gpus=8 --batch=32 --gamma=6.6 --mirror=1 --kimg=5000 --snap=10 --resume=https://api.ngc.nvidia.com/v2/models/nvidia/research/stylegan3/versions/1/files/stylegan3-t-ffhq-256x256.pkl
...
# ! use with 256 --cfg=stylegan2 --gpus=4 --batch=64 --gamma=0.2048 --map-depth=2 --glr=0.0025 --dlr=0.0025 --cbase=16384  \
...
# --label_combo_dict='{"label1":[0,11],"label2":[11,13]}' \
# --label_emb_dict='{"label1":256,"label2":256}' \
  
# --map-depth=2
# -label_combo_dict='{"label1":[0,11],"label2":[11,16],"label3":[16,18]}' \
# --label_emb_dict='{"label1":128,"label2":64,"label3":64}' \
# '{"label1":384,"label2":64,"label3":64}'
# '{"label1":256,"label2":128,"label3":128}'
# --label_to_int=True \


# label_type_dict = {'label1':args.disease, 'label2':args.age_bracket}

# --gpus=4 --batch=32 --gamma=5 --mirror=1 --kimg=30000 --snap=10

# --freezed=13 \
# --gamma=0.4096 --map-depth=8 --glr=0.0025 --dlr=0.0025 --cbase=16384 --snap=10
# --map-depth=8 --cbase=16384 --snap=10
# --gpus=2 --batch=32 --gamma=10 --map-depth=8 --cbase=16384 --snap=10
...
IMG_FOLDER = 'Res256AlignPix255-NoExternal-BgUp1-4' # 'Res256ManyCondition+10kNormal-OtherUp2-10' # 'TfStyleGAN3LabelRes256' Res256ManyCondition+10kNormal-OtherUp2-10 -SkipAge-SkipGender
...
# os.system('sbatch --partition=gpu --time=48:00:00 --gres=gpu:v100x:4 --mem=32g --cpus-per-task=12 '+fname)
os.system('sbatch --partition=gpu --time=16:00:00 --gres=gpu:p100:4 --mem=32g --cpus-per-task=12 '+fname) # ! 256 pixel
